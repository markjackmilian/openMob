...
/// <summary>
/// Provides Unicode glyph constants for Material Symbols Outlined icon font.
/// Use with FontFamily="MaterialSymbols" in XAML.
...
public static class MaterialIcons
{
    ...
    /// <summary>Error / circle with exclamation icon.</summary>
    ...
    /// <summary>Arrow back icon.</summary>
    public const string ArrowBack = "\ue5c4";

    /// <summary>Expand more / chevron down icon.</summary>
