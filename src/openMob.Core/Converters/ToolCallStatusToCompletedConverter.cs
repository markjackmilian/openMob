...
/// has completed successfully. Returns <see langword="true"/> for <see cref="ToolCallStatus.Completed"/>;
/// <see langword="false"/> otherwise.
/// </summary>
public sealed class ToolCallStatusToCompletedConverter
{
    /// <summary>
    /// Converts a <see cref="ToolCallStatus"/> to a completed-state visibility boolean.
    /// </summary>
    ...
    /// <returns>
    /// <see langword="true"/> when the status is <see cref="ToolCallStatus.Completed"/>;
    /// <see langword="false"/> otherwise.
    /// </returns>
    public object Convert(object? value, Type targetType, object? parameter, CultureInfo culture)
        => value is ToolCallStatus.Completed;
