...
{
    /// <summary>
    /// Registers all openMob Core services: SQLite database, HTTP client, infrastructure services,
    ...
    {
        // sqlite-net-pcl — Singleton connection, initialised at startup via IAppDatabase.InitializeAsync()
        ...
        // Server connection repository (Singleton-safe — IAppDatabase is Singleton)
        services.AddSingleton<IServerConnectionRepository, ServerConnectionRepository>();
