...
using CoreConverter = openMob.Core.Converters.SenderTypeToFallbackVisibilityConverter;
...
/// Returns <c>true</c> when the bound value is <see cref="openMob.Core.Models.SenderType.Fallback"/>.
/// </summary>
public sealed class SenderTypeToFallbackVisibilityConverter : IValueConverter
{
