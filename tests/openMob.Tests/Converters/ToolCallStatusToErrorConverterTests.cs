...
/// <summary>
/// Unit tests for <see cref="ToolCallStatusToErrorConverter"/>.
/// </summary>
public sealed class ToolCallStatusToErrorConverterTests
{
    private readonly ToolCallStatusToErrorConverter _sut = new();
    ...
    [InlineData(ToolCallStatus.Error,     true)]
    public void Convert_ReturnsExpectedErrorState(ToolCallStatus status, bool expected)
    {
        // Act
